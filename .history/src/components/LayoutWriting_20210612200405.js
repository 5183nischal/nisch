...
export default function LayoutWhite({ children, yearList, writingInfo }) {
  return (
    <div className="flex flex-col md:flex-row">
      ...
      ></section>
      <section className="h-px100 my-px20 mx-3/50 order-4 md:h-auto md:w-px150 md:ml-px40 md:mr-px20 md:mt-px80 md:order-none">
        <div className="text-center md:text-right md:sticky md:top-px10 md:leading-3p5em">

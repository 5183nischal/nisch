...
export default function LayoutWhite({ children, yearList, writingInfo }) {
  return (
    <div className="flex flex-col md:flex-row">
      ...
      ></section>
      <section className="h-px100 my-px20 mx-3/50 order-4 md:h-auto md:w-px100 md:ml-px10 md:mr-px10 md:mt-px30 md:order-none">
        <div className="text-center md:text-right md:sticky md:top-px50 md:leading-1p75em text-1r">
          <Nav sideBarOnMd={false} bgLight={true}></Nav>
          {writingInfo}
        </div>
      </section>

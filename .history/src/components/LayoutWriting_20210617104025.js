...
export default function LayoutWhite({ children, yearList, writingInfo }) {
  return (
    <div className="flex flex-col md:flex-row">
      ...
      ></section>
      <section className="h-px100 my-px10 mx-2/25 order-4 md:bottom-0 md:h-auto md:w-px100 md:ml-px40 md:mr-px10 md:order-none">
        <div className="text-center md:text-right md:sticky md:top-px200 md:leading-1p5em text-1r text-orange">

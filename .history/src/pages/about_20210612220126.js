      ...
      <section className="mx-2/25 flex-1 md:m-px50">
        <div className="hyphens-auto md:max-w-px550 lg:overflow-visible">
          ...
          <p className="my-px20">
            ...
            I am interested in understanding mechanism of biological and artificial intelligence and philosophy of 
            ...
            of technology in society. All of this started with an undergraduate degree in Mathematics from 
            {" "}
            <a
              href="https://nischalmainali.xyz/static/cv-4fdbc61efcaff4091d77daebf8ed8197.pdf"
              className=" border-b border-orange hover:border-red"

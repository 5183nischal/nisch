...
const creatYearList = (groups) => {
  return (
    <div className="w-px100 mt-px50 text-right text-orange font-helvetica text-p65r leading-1p5em">
      <ul>
...
export default function PostsPage({ data }) {
  ...
  return (
    <LayoutWhite yearList={creatYearList(groups)}>
      ...
      <section className="mx-2/25 flex-1 md:m-px20">
        <div className="md:max-w-px550">
          <h1 className="mt-px20 mb-px30 text-4p5r tracking-npx6 leading-1em font-helvetica font-light hyphens-auto text-orange md:text-5p75r">
            Essays
          </h1>
            ...
            {groups.map((group) => {
              ...
              return (
                <div key={year}>
                  <h2
                    id={year}
                    className="mt-px30 -mb-px00 text-1p5r font-helvetica tracking-npx1"
                  >
                    {year}
                  </h2>
                        ...
                        <li key={index} className="mb-px35">
                          ...
                          <div className="leading-1p2em font-helvetica">
                            <Link
                              to={slug}
                              title={title}
                              className="font-normal text-p95r text-orange"
                            >
                              {title}
                            </Link>
                          ...
                          <p className="mt-px5 text-p9r leading-1p7em font-thin text-quote">
                            {hook}
                          </p>
                        </li>
                      );

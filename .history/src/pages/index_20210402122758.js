      ...
      >
        ...
        >
          ...
          <p className="my-px10 hyphens-auto">
            I&apos;m{" "}
            Nischal and I study minds and machines.
          </p>
          <p className="my-px10 hyphens-auto">
          At ELSC, I study the learning and computational property of the brain and Artificial Neural Networks.
          More broadly, I am also interested in philosophy of intentionality.
          </p>
          <p className="my-px10 hyphens-auto">
          At 3ai, I focus on bringing AI to scale.

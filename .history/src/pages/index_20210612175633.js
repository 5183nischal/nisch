...
export default function IndexPage({ data }) {
  ...
  return (
    <LayoutBlack>
      ...
      <section
        id="content"
        className="mx-2/25 max-w-px1920 flex flex-col justify-center text-1p2r leading-1p9em md:flex-row md:mx-0 md:my-px60 md:text-3r md:leading-1p7em font-thin"
      >
        <div
          id="text"

...
export default function IndexPage() {
  ...
  return (
    <LayoutBlack>
      ...
      <section
        id="content"
        className="mx-2/25 max-w-px1920 flex flex-col justify-center text-1p2r leading-1p9em md:flex-row md:mx-0 md:my-px20 md:text-2r md:leading-1p7em"
      >
        <div
          id="text"
          className="md:ml-px80 md:mr-px20 md:max-w-px200 md:flex-shrink"
        >

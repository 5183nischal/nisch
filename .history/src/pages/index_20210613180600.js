...
export default function IndexPage() {
  ...
  return (
    <LayoutBlack>
      ...
      <section
        id="content"
        className="mx-2/25 max-w-px1920 flex flex-col justify-left text-1p2r leading-1p9em md:flex-row md:mx-10 md:my-px20 md:text-3r md:leading-1p7em"
      >
        <div
          id="text"
        ...
        >
          <p className="my-px10 hyphens-auto">
            I&apos;m निश्चल \ Nischal &amp; this site is a collection of my work &amp; essays. 
          </p>

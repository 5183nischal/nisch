...
export default function FragmentsPage({ data }) {
  ...
  return (
    <LayoutWhite yearList={creatYearList(groups)}>
      <SEO title="Work" description="nisch work" />
      <section className="mx-2/25 pt-px10 flex-1 md:m-px50">
        <div className="max-w-px700">
          <h1 className="mt-px20 mb-px50 font-helvetica font-light text-orange text-3r tracking-npx4 leading-1em hyphens-auto md:text-4r">
            Work
          </h1>
          <div

    ...
    <LayoutWhite writingInfo={infoCard}>
      ...
      <section className="mx-2/25 flex-1 md:m-px50">
        <div className="max-w-px1000">
          <h1 className="mt-px20 mb-px40 pb-px40 text-4p5r text-orange leading-1em tracking-npx6 hyphens-auto text-black border-b-8 border-black md:mb-px50 md:pb-px50 md:border-b-10 md:text-5p75r md:hyphens-none lg:mb-px50 lg:pb-px50">
            {title}
          </h1>
        </div>
        <div className="max-w-px680">
          ...
          <MDXProvider components={components}>
            <div className="md:max-w-px550 lg:overflow-visible text-orange">
